...
BEGIN
    ...
    RAISE NOTICE 'Seeding AI Hub database...';
END $$;
...
VALUES
    ...
    (
        ...
        'Leidenschaftliche KI-Enthusiastin und Treiberin der digitalen Transformation im Unternehmen. Ich glaube fest daran, dass KI uns allen den Arbeitsalltag erleichtern kann.',
...
VALUES
    ...
    (
        ...
        'Wie man Google Gemini fuer die Analyse von Geschaeftsdaten einsetzt - mit konkreten Beispielen aus dem Unternehmens-Vertrieb.',
        'data_analysis',
...
VALUES
    ...
    (
        ...
        'Werde zum Prompt-Engineering-Profi! Lerne fortgeschrittene Techniken wie Chain-of-Thought, Few-Shot-Learning und System-Prompts. Mit vielen praktischen Uebungen und realen Beispielen aus dem Unternehmenskontext.',
...
VALUES
    ...
    (
        ...
        'Innovation Sprint: Beste KI-Idee fuer den Vertrieb',
...
VALUES
    (
        ...
        'Entdecke die Welt der Kuenstlichen Intelligenz und lerne, wie du KI-Tools effektiv in deinem taeglichen Arbeitsablauf einsetzen kannst. Von den Basics bis zum ersten eigenen Prompt -- dieser Kurs macht dich fit fuer die KI-gestuetzte Zukunft im Unternehmen.',
    ...
    (
        ...
        'Prompt Engineering Masterclass',
        'Werde zum Prompt-Profi! In dieser Masterclass lernst du fortgeschrittene Prompting-Techniken und erhaeltst praxiserprobte Vorlagen fuer Vertrieb, Marketing und Analyse -- massgeschneidert fuer den Unternehmensalltag.',
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '=== AI Hub Seed Summary ===';
